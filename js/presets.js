...
import {
  ...
  elVol0, elVol1, elOffset0, elOffset1, elFgOpacity,
...
export function collectSettings() {
  return {
    ...
    filterPencil:     elFilterPencil.value,
    filterEmboss:     elFilterEmboss.value,
    filterChalkboard: elFilterChalkboard.value,
    filterNightVision:elFilterNightVision.value,
    filterAirbrush:   elFilterAirbrush.value,
...
export function applySettings(d) {
  const sliders = [
    ...
    ['filterPencil','filterPencilVal'],
    ['filterEmboss','filterEmbossVal'],
    ['filterChalkboard','filterChalkboardVal'],
    ['filterNightVision','filterNightVisionVal'],
    ['filterAirbrush','filterAirbrushVal'],
  ...
  const vals = {
    ...
    filterPencil:     d.filterPencil     ?? '0',
    filterEmboss:     d.filterEmboss     ?? '0',
    filterChalkboard: d.filterChalkboard ?? '0',
    filterNightVision:d.filterNightVision?? '0',
    filterAirbrush:   d.filterAirbrush   ?? '0',
