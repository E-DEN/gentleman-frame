...
// ======================== メガネスタイル定義 (7種) ========================
// 各スタイルの変換パラメータ:
//   ox = tx2 * 4.166667 + tx1  (viewBox内パス原点X)
//   oy = ty2 * 4.166667 + ty1  (viewBox内パス原点Y)
// lens: レンズ2サブパス (クリップマスク用 fill)
// full: 全3サブパス (フレームストローク用)
const _GS = 4.166667; // SVGスケール定数
const _GLASSES_STYLES = [
  { // 0: スライス1 — ラウンド
...
//   maskBlur       : 0–10    (default 0) ← マスクセクション
//   maskPixel      : 0–10    (default 0) ← マスクセクション
const _FQP = {
