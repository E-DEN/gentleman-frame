...
export const elFgOpacity = document.getElementById('fgOpacity');
...
export const elFilterBloom = document.getElementById('filterBloom');
export const elFilterPencil      = document.getElementById('filterPencil');
export const elFilterEmboss      = document.getElementById('filterEmboss');
export const elFilterChalkboard  = document.getElementById('filterChalkboard');
export const elFilterNightVision = document.getElementById('filterNightVision');
export const elFilterAirbrush    = document.getElementById('filterAirbrush');
