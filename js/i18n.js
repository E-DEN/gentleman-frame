...
registerLang('ja', '日本語', {
  ...
  'shape':'形状','形状':'形状','shape-rect':'四角','shape-circle':'円','shape-heart':'ハート','shape-phone':'スマホ','shape-glasses':'メガネ','glasses-style':'スタイル',
...
registerLang('en', 'English', {
  ...
  'shape':'Shape','shape-rect':'Rect','shape-circle':'Circle','shape-heart':'Heart','shape-phone':'Phone','shape-glasses':'Glasses','glasses-style':'Style',
...
registerLang('zh', '中文', {
  ...
  'shape':'形状','shape-rect':'矩形','shape-circle':'圆形','shape-heart':'心形','shape-phone':'手机','shape-glasses':'眼镜','glasses-style':'样式',
