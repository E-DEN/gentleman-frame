...
registerLang('ja', '日本語', {
  ...
  'shape':'形状','形状':'形状','shape-rect':'四角','shape-circle':'円','shape-heart':'ハート','shape-phone':'スマホ','shape-glasses':'メガネ','shape-glasses2':'丸メガネ','glasses-type':'タイプ',
...
registerLang('en', 'English', {
  ...
  'shape':'Shape','shape-rect':'Rect','shape-circle':'Circle','shape-heart':'Heart','shape-phone':'Phone','shape-glasses':'Glasses','shape-glasses2':'Round','glasses-type':'Type',
...
registerLang('zh', '中文', {
  ...
  'shape':'形状','shape-rect':'矩形','shape-circle':'圆形','shape-heart':'心形','shape-phone':'手机','shape-glasses':'眼镜','shape-glasses2':'圆框眼镜','glasses-type':'类型',
