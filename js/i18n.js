...
registerLang('ja', '日本語', {
  ...
  'vol':'音量','offset':'オフセット','fg-opacity':'透過度','swap-title':'背景・前景入れ替え',
  ...
  'shape':'形状','形状':'形状','shape-rect':'四角','shape-circle':'円','shape-heart':'ハート','shape-phone':'スマホ','shape-glasses':'メガネ','shape-spectrum':'スペクトラム','glasses-style':'スタイル',
  'spec-style':'スタイル','spec-style-bars':'バー','spec-style-mirror':'ミラー','spec-style-radial':'円形',
  'spec-shape':'形状','spec-shape-bars':'バー','spec-shape-radial':'円形','spec-shape-ring':'リング',
  'spec-sym':'対称','spec-sym-none':'なし','spec-sym-ud':'上下','spec-sym-lr':'左右',
  'spec-rotate':'回転',
  'spec-smooth':'滑らかさ','spec-bars':'バー数','spec-amp':'感度','spec-gap':'隙間',
  ...
  'fg-anchor-show':'アンカー',
  'fg-pin-x':'アンカー X','fg-pin-y':'アンカー Y','fg-pin-lerp':'アンカー追従','fg-pin-opacity':'アンカー透過',
  'border-w':'枠太さ','枠の太さ':'枠太さ','border-op':'枠透過','border-col':'枠色',
  ...
  'border-speed':'枠速度','border-bright':'枠輝度','frame-blur':'枠ぼかし','frame-tint':'枠色合い',
  'brightness':'明るさ','contrast':'コントラスト','saturation':'彩度','filter-hue':'色相',
  'ca':'色収差','vignette':'ビネット',
  'filter-temp':'色温度','filter-matte':'マット','filter-grain':'ノイズ',
  'filter-pixel':'ピクセル化','filter-flare':'カラーフレア','filter-rain':'雨','filter-blur':'ぼかし',
  'mask-blur':'マスクぼかし','mask-pixel':'マスクピクセル',
  'rain-speed':'雨 - 速度','rain-refraction':'雨 - 屈折','rain-shadow':'雨 - 影',
  'filter-bars':'レターボックス','filter-fps':'フレームレート',
  'filter-highlight':'ハイライト','filter-shadow':'シャドウ','filter-tint':'色かぶり補正','filter-sharpness':'シャープネス','filter-bloom':'にじみ','filter-pencil':'鉛筆','filter-emboss':'エンボス','filter-chalkboard':'黒板','filter-nightvision':'暗視','filter-airbrush':'エアブラシ','filter-artistic-label':'描画エフェクト','filter-maskonly':'マスク内のみ',
  ...
  'fqp-noir':'ノワール','fqp-horror':'ホラー','fqp-modern':'モダン','fqp-trend':'トレンド','fqp-prism':'プリズム',
  ...
  'actual-size-open':'原寸表示','actual-size-close':'原寸解除',
  ...
  'preset-file-permission':'ファイルへのアクセス許可が必要です。もう一度お試しください',
...
registerLang('en', 'English', {
  ...
  'vol':'Volume','offset':'Offset','fg-opacity':'Opacity','swap-title':'Swap BG / FG',
  ...
  'shape':'Shape','shape-rect':'Rect','shape-circle':'Circle','shape-heart':'Heart','shape-phone':'Phone','shape-glasses':'Glasses','shape-spectrum':'Spectrum','glasses-style':'Style',
  'spec-style':'Style','spec-style-bars':'Bars','spec-style-mirror':'Mirror','spec-style-radial':'Radial',
  'spec-shape':'Shape','spec-shape-bars':'Bars','spec-shape-radial':'Radial','spec-shape-ring':'Ring',
  'spec-sym':'Symmetry','spec-sym-none':'None','spec-sym-ud':'Top/Bottom','spec-sym-lr':'Left/Right',
  'spec-rotate':'Rotate',
  'spec-smooth':'Smooth','spec-bars':'Bar Count','spec-amp':'Sensitivity','spec-gap':'Gap',
  ...
  'fg-pin-x':'Anchor X','fg-pin-y':'Anchor Y','fg-pin-lerp':'Anchor Speed','fg-pin-opacity':'Anchor Alpha',
  'border-w':'Border Width','border-op':'Border Alpha','border-col':'Border Color',
  ...
  'border-speed':'Speed','border-bright':'Luminosity','frame-blur':'Frame Blur','frame-tint':'Frame Tint',
  'brightness':'Brightness','contrast':'Contrast','saturation':'Saturation','filter-hue':'Hue',
  'ca':'Aberration','vignette':'Vignette',
  'filter-temp':'Temp','filter-matte':'Matte','filter-grain':'Noise',
  'filter-pixel':'Pixelate','filter-flare':'Color Flare','filter-rain':'Rain','filter-blur':'Blur',
  'mask-blur':'Mask Blur','mask-pixel':'Mask Pixel',
  'rain-speed':'Rain - Speed','rain-refraction':'Rain - Refraction','rain-shadow':'Rain - Shadow',
  'filter-bars':'Letterbox','filter-fps':'Frame Rate',
  'filter-highlight':'Highlights','filter-shadow':'Shadows','filter-tint':'Tint','filter-sharpness':'Sharpness','filter-bloom':'Bloom','filter-pencil':'Pencil','filter-emboss':'Emboss','filter-chalkboard':'Chalkboard','filter-nightvision':'Night Vision','filter-airbrush':'Airbrush','filter-artistic-label':'Artistic Effects','filter-maskonly':'Mask Only',
  ...
  'fqp-noir':'Noir','fqp-horror':'Horror','fqp-modern':'Modern','fqp-trend':'Trend','fqp-prism':'Prism',
  ...
  'actual-size-open':'Actual size','actual-size-close':'Exit actual size',
  ...
  'preset-file-permission':'File access permission is required. Please try again',
...
registerLang('zh', '中文', {
  ...
  'vol':'音量','offset':'偏移','fg-opacity':'透明度','swap-title':'交换背景与前景',
  'shape':'形状','shape-rect':'矩形','shape-circle':'圆形','shape-heart':'心形','shape-phone':'手机','shape-glasses':'眼镜','shape-spectrum':'频谱','glasses-style':'样式',
  'spec-style':'样式','spec-style-bars':'条形','spec-style-mirror':'镜像','spec-style-radial':'放射形',
  'spec-shape':'形状','spec-shape-bars':'条形','spec-shape-radial':'放射形','spec-shape-ring':'环形',
  'spec-sym':'对称','spec-sym-none':'无','spec-sym-ud':'上下','spec-sym-lr':'左右',
  'spec-rotate':'旋转',
  'spec-smooth':'平滑','spec-bars':'条数','spec-amp':'灵敏度','spec-gap':'间隙',
  ...
  'fg-anchor-show':'锚点',
  'fg-pin-x':'锦点 X','fg-pin-y':'锦点 Y','fg-pin-lerp':'锦点追随','fg-pin-opacity':'锦点透明度',
  ...
  'border-speed':'速度','border-bright':'明度','frame-blur':'边框模糊','frame-tint':'边框色调',
  'brightness':'亮度','contrast':'对比度','saturation':'饱和度','filter-hue':'色相',
  'ca':'色差','vignette':'暗角',
  'filter-temp':'色温','filter-matte':'哑光','filter-grain':'噪点',
  ...
  'fqp-noir':'黑白','fqp-horror':'恐怖','fqp-modern':'现代','fqp-trend':'潮流','fqp-prism':'棱镜',
  ...
  'actual-size-open':'原尺寸显示','actual-size-close':'退出原尺寸',
  ...
  'preset-file-permission':'需要文件访问权限，请重试',
