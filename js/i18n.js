...
registerLang('ja', '日本語', {
  ...
  'filter-pixel':'ピクセル化','filter-flare':'カラーフレア','filter-rain':'雨',
...
registerLang('en', 'English', {
  ...
  'filter-pixel':'Pixelate','filter-flare':'Color Flare','filter-rain':'Rain',
...
registerLang('zh', '中文', {
  ...
  'filter-pixel':'像素化','filter-flare':'色彩光晕','filter-rain':'雨',
