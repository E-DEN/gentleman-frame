...
registerLang('ja', '日本語', {
  ...
  'spec-shape':'形状','spec-shape-bars':'バー','spec-shape-radial':'円形',
  ...
  'filter-highlight':'ハイライト','filter-shadow':'シャドウ','filter-tint':'色かぶり補正','filter-sharpness':'シャープネス','filter-watercolor':'にじみ','filter-pencil':'鉛筆','filter-emboss':'エンボス','filter-chalkboard':'黒板','filter-nightvision':'暗視','filter-airbrush':'エアブラシ','filter-artistic-label':'描画エフェクト','filter-frameonly':'フレーム内のみ',
  ...
  'fqp-noir':'ノワール','fqp-horror':'ホラー','fqp-modern':'モダン','fqp-trend':'トレンド','fqp-prism':'プリズム','fqp-watercolor':'にじみ',
...
registerLang('en', 'English', {
  ...
  'spec-shape':'Shape','spec-shape-bars':'Bars','spec-shape-radial':'Radial',
  ...
  'filter-highlight':'Highlights','filter-shadow':'Shadows','filter-tint':'Tint','filter-sharpness':'Sharpness','filter-watercolor':'Bloom','filter-pencil':'Pencil','filter-emboss':'Emboss','filter-chalkboard':'Chalkboard','filter-nightvision':'Night Vision','filter-airbrush':'Airbrush','filter-artistic-label':'Artistic Effects','filter-frameonly':'Frame Only',
  ...
  'fqp-noir':'Noir','fqp-horror':'Horror','fqp-modern':'Modern','fqp-trend':'Trend','fqp-prism':'Prism','fqp-watercolor':'Bloom',
...
registerLang('zh', '中文', {
  ...
  'spec-shape':'形状','spec-shape-bars':'条形','spec-shape-radial':'放射形',
...
'filter-bars':'信筱遥幅','filter-fps':'帧率',  'filter-highlight':'高光','filter-shadow':'阴影','filter-tint':'色调','filter-sharpness':'锐化','filter-watercolor':'晩染','filter-pencil':'铅笔素描','filter-emboss':'浮雕','filter-chalkboard':'粉笔','filter-nightvision':'夜视','filter-airbrush':'喷笔','filter-artistic-label':'艺术效果','filter-frameonly':'仅框内',
  'fqp-cinema':'电影','fqp-retro':'复古','fqp-insta':'网红',
  'fqp-pastel':'粉彩','fqp-neon':'霓虹','fqp-sunset':'夕阳',
  'fqp-cool':'冷色','fqp-dreamy':'梦幻','fqp-glitch':'故障',
  'fqp-noir':'黑白','fqp-horror':'恐怖','fqp-modern':'现代','fqp-trend':'潮流','fqp-prism':'棱镜','fqp-watercolor':'晕染',
