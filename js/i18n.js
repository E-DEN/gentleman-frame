...
registerLang('ja', '日本語', {
  ...
  'width':'幅','height':'高さ','mask-x':'X 位置','mask-y':'Y 位置','mask-zoom':'ズーム','blur':'ぼかし',
  ...
  'file-resolve-by-file':'ファイルを選択',
  'file-resolve-by-file-hint':'ダウンロードフォルダなど、場所を問わず使えます',
  'file-resolve-by-folder':'フォルダを選択して一括解決',
  'file-resolve-by-folder-hint':'専用フォルダにまとめて保存している場合に便利です',
  ...
  'file-mismatch-title':'ファイル名が一致しません',
  'file-mismatch-expected':'プリセットの登録名',
  'file-mismatch-picked':'選択したファイル名',
  'file-mismatch-use':'そのまま使用',
  'file-mismatch-repick':'選び直す',
...
registerLang('en', 'English', {
  ...
  'width':'Width','height':'Height','mask-x':'X Pos','mask-y':'Y Pos','mask-zoom':'Zoom','blur':'Blur',
  ...
  'file-resolve-by-file':'Select file(s)',
  'file-resolve-by-file-hint':'Works for any folder, including Downloads',
  'file-resolve-by-folder':'Select folder (batch resolve)',
  'file-resolve-by-folder-hint':'Handy when all files are in a dedicated folder',
  ...
  'file-mismatch-title':'File name mismatch',
  'file-mismatch-expected':'Preset filename',
  'file-mismatch-picked':'Selected filename',
  'file-mismatch-use':'Use anyway',
  'file-mismatch-repick':'Pick again',
...
registerLang('zh', '中文', {
  ...
  'width':'宽度','height':'高度','mask-x':'X 位置','mask-y':'Y 位置','mask-zoom':'缩放','blur':'模糊',
  ...
  'file-resolve-by-file-hint':'适用于任意文件夹（包括下载文件夹）',
  'file-resolve-by-folder':'选择文件夹（批量解决）',
  'file-resolve-by-folder-hint':'文件集中存放时更方便',
  'file-resolve-cancel':'取消',
  'file-resolve-ok':'确定',
  'file-resolve-slot-drop':'拖放到此处或点击选择',
  'file-resolve-folder-btn':'选择文件夹',
  'file-resolve-name-warn':'文件名不匹配',
  'file-mismatch-title':'文件名不匹配',
  'file-mismatch-expected':'预设文件名',
  'file-mismatch-picked':'已选文件名',
  'file-mismatch-use':'仍然使用',
  'file-mismatch-repick':'重新选择',
  'import-code':'导入代码',
