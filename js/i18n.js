...
registerLang('ja', '日本語', {
  ...
  'filter-highlight':'ハイライト','filter-shadow':'シャドウ','filter-tint':'色かぶり補正','filter-sharpness':'シャープネス','filter-watercolor':'にじみ',
...
registerLang('en', 'English', {
  ...
  'filter-highlight':'Highlights','filter-shadow':'Shadows','filter-tint':'Tint','filter-sharpness':'Sharpness','filter-watercolor':'Bloom',
...
registerLang('zh', '中文', {
  ...
  'filter-bars':'信箱遮幅','filter-fps':'帧率',  'filter-highlight':'高光','filter-shadow':'阴影','filter-tint':'色调','filter-sharpness':'锐化','filter-watercolor':'晕染',
