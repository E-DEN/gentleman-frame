...
registerLang('ja', '日本語', {
  ...
  'vid-title':'動画',  'vid1-title':'動画 1（背景）','vid2-title':'動画 2（前景）',
...
registerLang('en', 'English', {
  ...
  'vid-title':'Videos',  'vid1-title':'Video 1 (Background)','vid2-title':'Video 2 (Foreground)',
...
registerLang('zh', '中文', {
  ...
  'vid-title':'视频',  'vid1-title':'视频 1（背景）','vid2-title':'视频 2（前景）',
