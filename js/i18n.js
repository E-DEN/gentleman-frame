...
registerLang('ja', '日本語', {
  ...
  'fg-anchor-show':'アンカー表示','fg-anchor-hide':'アンカー表示中（クリックで非表示）',
  'fg-pin-x':'X 位置','fg-pin-y':'Y 位置',
...
registerLang('en', 'English', {
  ...
  'fg-anchor-show':'Show anchor','fg-anchor-hide':'Anchor visible (click to hide)',
  'fg-pin-x':'X Pos','fg-pin-y':'Y Pos',
...
registerLang('zh', '中文', {
  ...
  'fg-anchor-show':'显示锥点','fg-anchor-hide':'锥点显示中（点击隐藏）',
  'fg-pin-x':'X 位置','fg-pin-y':'Y 位置',
