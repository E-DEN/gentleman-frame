...
registerLang('ja', '日本語', {
  ...
  'phone-ui':'表示','phone-ui-rot90':'横向き','phone-ui-rot':'三等分グリッド','phone-ui-rec':'録画/タイムコード','phone-ui-dot':'パンチホール',
...
registerLang('en', 'English', {
  ...
  'phone-ui':'Show','phone-ui-rot90':'Landscape','phone-ui-rot':'Rule of Thirds','phone-ui-rec':'REC / Timecode','phone-ui-dot':'Punch Hole',
...
registerLang('zh', '中文', {
  ...
  'phone-ui':'显示','phone-ui-rot90':'横向','phone-ui-rot':'三分居网格','phone-ui-rec':'录制/时间码','phone-ui-dot':'打孔摄像头',
