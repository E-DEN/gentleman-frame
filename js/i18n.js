...
registerLang('ja', '日本語', {
  ...
  'border-anim-neon':'ネオン','border-anim-fire':'ファイア','border-anim-pink':'ピンク',
...
registerLang('en', 'English', {
  ...
  'border-anim-neon':'Neon','border-anim-fire':'Fire','border-anim-pink':'Pink',
...
registerLang('zh', '中文', {
  ...
  'border-anim-neon':'霸费光','border-anim-fire':'火焰','border-anim-pink':'粉色',
